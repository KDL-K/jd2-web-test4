...
public final class ConnectionPool {
    ...
    private BlockingQueue<Connection> freeConInPool;
    private BlockingQueue<Connection> usingConInPool;
    ...
    public ConnectionPool() throws ConnectionPoolException{
        ...
        login = manager.getValue("db.login");
    ...
    public void closeConnectionPool(){
        clearQueueOfCon(freeConInPool);
        clearQueueOfCon(usingConInPool);
    }

    public void clearQueueOfCon(BlockingQueue<Connection> queue){
